...
+ (OSStatus)mix:(NSString*)file1 withSound:(NSString*)file2 atOffset:(NSTimeInterval)offset forDest:(NSString*)mixfile
{
...
#define BUFFER_SIZE 4096
    ...
    UInt32 skipPackets = inputDataFormat.mSampleRate * offset;
    ...
    while (skipPackets > 0) {
        ...
        numPackets1 = (skipPackets < numPackets1 ) ? skipPackets : numPackets1;
	...
	while (TRUE) {
		...
		int numSamples = (maxNumPackets * inputDataFormat.mBytesPerPacket) / sizeof(int16_t); // should this be maxNumPackets or numPackets1??
